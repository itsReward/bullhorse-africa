        ...
        <div class="about-section">
            ...
            <div class="about-grid">
                <div class="about-card">
                    ...
                    <p class="about-card-text">We position ourselves as a high-end supplier, striving for parts that meet or exceed OEM (Original Equipment Manufacturer) standards.</p>
                </div>
                ...
                <div class="about-card">
                    ...
                    <h3 class="about-card-title">Ordering/Inquiry</h3>
                    <p class="about-card-text">Just click WhatsApp button for ordering or quotation. We're ready to assist you with your truck parts needs.</p>
                    <a href="https://wa.me/YOUR_PHONE_NUMBER?text=I'm interested in getting a quotation" target="_blank" class="about-whatsapp-btn">
                ...
                <div class="about-card">
                    ...
                    <h3 class="about-card-title">Customer Focus</h3>
